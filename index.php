<?php include_once 'includes/templates/header.php'; ?>
  <section class="seccion contenedor">
    <h2>La mejor conferencia de IT en español</h2>
    <p>
      El programa general de esta conferencia consiste en conocer y manejar aplicaciones específicas para el
      tratamiento, integración, gestión y análisis de macrodatos estructurados y no estructurados, así como los
      principios de funcionamiento del Big Data para abordar actividades empresariales relacionadas con el desarrollo de
      productos, el mantenimiento predictivo, la experiencia del cliente, la lucha contra el fraude y la eficiencia
      operativa.
    </p>
  </section><!--seccion-->
