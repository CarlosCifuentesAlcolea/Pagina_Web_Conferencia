(function() {
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		if (document.getElementById('mapa')) {
			var map = L.map('mapa').setView([40.416633, -3.703315], 17);

			L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png').addTo(map);

			L.marker([40.416633, -3.703315]).addTo(map).bindPopup('GDLWebCamp 2021 <br> Boletos ya disponibles').openPopup();
	...
	$(function() {
		...
		$('.cuenta-regresiva').countdown('2021/12/16 09:00:00', function(event) {
