    <footer class="site-footer">
      <div class="contenedor clearfix">
        <div class="footer-informacion">
          <h3>Sobre <span>ThinkBetter</span></h3>
        ...
        <div class="ultimos-tweets">
          ...
          <ul>
            <li>Integer ultricies justo nec firibus, eu interdum quam vulputate. #Pellentesque nec @justo non
              est efeifend
              pulvinar.</li>
            <li>Integer ultricies justo nec firibus, eu interdum quam vulputate. #Pellentesque nec @justo non
              est efeifend
      ...
      <p class="copyright">
        Todos los derechos Reservados THINKBETTER 2021.
      </p>
