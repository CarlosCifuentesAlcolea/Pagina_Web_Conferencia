                ...
                <div class="caja">
                    <div id="viernes" class="contenido-dia clearfix">
                        ...
                        <div>
                            ...
                            <label><input type="checkbox" name="registro[]" id="taller_03" value="taller_02"><time>14:00</time> HTML5 y CSS3</label>
                            <label><input type="checkbox" name="registro[]" id="taller_04" value="taller_02"><time>17:00</time> Drupal</label>
                            <label><input type="checkbox" name="registro[]" id="taller_05" value="taller_02"><time>19:00</time> WordPress</label>
                        </div>
                        <div>
                            <p>Conferencias:</p>
                            <label><input type="checkbox" name="registro[]" id="conf_01" value="conf_01"><time>10:00</time> Como ser Freelance</label>
                    ...
                    <div id="domingo" class="contenido-dia clearfix">
                        ...
                        <div>
                            ...
                            <label><input type="checkbox" name="registro[]" id="conf_09" value="conf_09"><time>19:00</time> Frameworks y leibrerias Open Source</label>
                        </div>
                        <div>
                            <p>Seminarios:</p>
                            <label><input type="checkbox" name="registro[]" id="sem_04" value="sem_04"><time>10:00</time> Creando una App en Android en una mañana</label>
                            <label><input type="checkbox" name="registro[]" id="sem_04" value="sem_05"><time>17:00</time> Creando una App en IOS en una tarde</label>
                        </div>
                    </div><!--.domingo-->
                </div><!--.caja-->
            </div><!--#eventos-->
